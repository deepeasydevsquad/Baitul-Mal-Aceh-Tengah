...
<template>
  <div>
    <button @click="showLogoutConfirmation" class="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out text-green-900 hover:text-green-700 lg:text-base w-full text-left">
    ...
    >
      <Teleport to="body">
          <div v-if="showConfirmation" class="fixed inset-0 bg-black/50 bg-opacity-50 flex items-center justify-center z-50" @click.self="hideLogoutConfirmation">
            ...
            <div v-if="showNotification" class="fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg z-50 flex items-center gap-2">
