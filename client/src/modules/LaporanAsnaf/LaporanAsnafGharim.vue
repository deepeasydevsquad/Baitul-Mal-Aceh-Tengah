...
//   try {
//     const response = await download_excel_asnaf(selectedTahun.value, 'Gharim');
...
//     link.href = url;
//     link.download = `Laporan_Asnaf_Gharim_${selectedTahun.value}.xlsx`;
...
const cetak_laporan = () => {
  const printUrl = `/cetak-laporan-asnaf-gharim/${selectedTahun.value}`;
