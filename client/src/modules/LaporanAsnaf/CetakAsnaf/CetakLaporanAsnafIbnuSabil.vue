...
const asnafId = 6; // ID untuk Asnaf
...
const handlePrint = () => {
  ...
  document.title = `Laporan Penyaluran Asnaf Ibnu Sabil ${tahun === '0' ? 'Semua Tahun' : 'Per Tahun ' + tahun}`;
  ...
  <div v-else class="min-h-screen p-4 print:p-0 print:m-0">
    ...
    >
      ...
      <div class="flex justify-between items-start mb-3">
        <div>
          <h1 class="text-lg font-bold mb-1">Laporan Penyaluran Asnaf Ibnu Sabil</h1>
