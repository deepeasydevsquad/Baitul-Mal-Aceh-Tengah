...
//   try {
//     const response = await download_excel_asnaf(selectedTahun.value, 'Fisabilillah');
...
//     link.href = url;
//     link.download = `Laporan_Asnaf_Fisabilillah_${selectedTahun.value}.xlsx`;
...
const cetak_laporan = () => {
  const printUrl = `/cetak-laporan-asnaf-filsabilillah/${selectedTahun.value}`;
