...
<template>
    <div class="mx-auto p-4">
        ...
        <div v-else class="space-y-4">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div class="flex items-center w-full sm:w-auto">
                    ...
                    <input id="search" type="text" v-model="search" @change="fetchData"  placeholder="Cari desa..."
                ...
                <table v-else class="w-full border-collapse bg-white text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <template v-if="dataDesa">
                            <tr v-for="data in dataDesa" :key="data.id" class="hover:bg-gray-50 transition-colors">
        ...
        <FormAdd :is-modal-open="isModalAddOpen" @close="isModalAddOpen = false; fetchData()" 
            @status="(payload: any) => displayNotification(payload.error_msg || 'Tambah/Update Desa gagal', payload.error ? 'error' : 'success')" />
        <!-- Modal FormEdit -->
        <FormEdit :is-modal-open="isModalEditOpen" :selected-desa="selectedDesa"
