...
const months = [
  ...
  { key: '04', label: 'APR' }, { key: '05', label: 'MEI' }, { key: '06', label: 'JUN' },
  { key: '07', label: 'JUL' }, { key: '08', label: 'AGS' }, { key: '09', label: 'SEP' },
...
<template>
  <div class="p-6">
    ...
    <div class="overflow-x-auto">
      ...
      >
        <thead>
          <tr class="bg-gradient-to-r from-gray-100 to-gray-300 text-black">
            <th class="px-6 py-3 text-center">No</th>
            <th class="px-6 py-3 text-left">Tipe Pengumpulan</th>
            <th
              v-for="m in months"
              :key="m.key"
