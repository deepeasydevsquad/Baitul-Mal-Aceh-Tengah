...
const { Sequelize, Asnaf, sequelize } = require("../../../models");
...
class Model_cud {
    ...
    async update() {
        ...
        this.t = await sequelize.transaction();
        try {
            const daftar_asnaf = await Asnaf.findByPk(body.id, { transaction: this.t });
            if (!daftar_asnaf) {
            ...
            this.state = true;
            this.message = 'Asnaf Berhasil Diperbaharui.';
        } catch (err) {
            this.message = err.message;
        }
    }
    ...
    async delete() {
        ...
        try {
            ...
            this.state = true;
            this.message = 'Asnaf Berhasil Dihapus.';
        } catch (err) {
            this.message = err.message;
        }
    }
