const { sequelize, Whatsapp_message } = require("../../../models");
...
class Model_cud {
  ...
  async insert_whatsapp_message(sender, data) {
    await this.initialize();
    const myDate = moment().format("YYYY-MM-DD HH:mm:ss");
    const body = this.req.body;
    try {
      for (let x in data) {
        await Whatsapp_message.create(
          {
            sender_number: sender,
            destination_number: data[x].destination,
