...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('Program_donasis', [

      {
        ...
        tahun: 2025,
        deskripsi: 'Program penggalangan dana untuk membantu renovasi Masjid Raya yang merupakan ikon kebanggaan kita bersama.',
  ...
  
      {
        ...
        tahun: 2025,
        deskripsi: 'Penggalangan dana cepat untuk membantu saudara-saudara kita yang terdampak bencana alam.',
