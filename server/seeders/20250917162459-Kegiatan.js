...
module.exports = {
  async up (queryInterface, Sequelize) {
      ...
      },
      {
        ...
        nama_kegiatan: `Bantuan Pendidikan Anak Yatim & Dhuafa ${Math.floor(Math.random() * 10) + 1}`,
        slug: `bantuan-pendidikan-anak-yatim-dhuafa-${Math.floor(Math.random() * 10) + 1}-2025`,
        status_tampil: Math.random() < 0.5 ? 'tampil' : 'tidak_tampil',
        jumlah_dana: Math.floor(Math.random() * 100000000) + 1000000,
        jumlah_maksimal_nominal_bantuan: Math.floor(Math.random() * 1000000) + 100000,
        ...
        status_kegiatan: Math.random() < 0.5 ? 'sedang_berlangsung' : 'selesai',
        tahun: 2025,
        banner: `${Math.floor(Math.random() * 10) + 1}.png`,
        desc: `Program bantuan biaya pendidikan untuk siswa/siswi yatim dan dhuafa di seluruh kabupaten ${Math.floor(Math.random() * 10) + 1}`,
        createdAt: new Date(),
        updatedAt: new Date()
      },
      {
        ...
        tahun: 2025,
        banner: `${Math.floor(Math.random() * 10) + 1}.png`,
        desc: `Program bantuan biaya pendidikan untuk siswa/siswi yatim dan dhuafa di seluruh kecamatan ${Math.floor(Math.random() * 10) + 1}`,
        createdAt: new Date(),
        updatedAt: new Date()
      }
    ], {});
