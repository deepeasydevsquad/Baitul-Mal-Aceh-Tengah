...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Submenus', [
      ...
      { menu_id : menus[2].id, name: 'Keanggotaan', path: 'keanggotaan', tab:`[{"id":"${tabs[15].id}"}]`,  createdAt: new Date(), updatedAt: new Date() },
      ...
      { menu_id : menus[4].id, name: 'Laporan Umum', path: 'laporan_umum', tab:`[{"id":"${tabs[31].id}"}]`,  createdAt: new Date(), updatedAt: new Date() },
      { menu_id : menus[4].id, name: 'Laporan Pengumpulan', path: 'laporan_pengumpulan', tab:`[]`,  createdAt: new Date(), updatedAt: new Date() },
      ...
      { menu_id : menus[5].id, name: 'Whatsapp', path: 'whatsapp', tab:`[{"id":"${tabs[27].id}"},{"id":"${tabs[26].id}"}]`,  createdAt: new Date(), updatedAt: new Date() },
